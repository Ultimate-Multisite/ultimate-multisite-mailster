<?php
/**
 * PHPUnit bootstrap file for Mailster Integration addon.
 *
 * @package MAILSTER
 */
...
/**
 * Manually load the main plugin first (required dependency).
 */
function _manually_load_main_plugin() {
	// Load the main Multisite Ultimate plugin first
	if ( file_exists(dirname(dirname(__DIR__)) . '/multisite-ultimate/multisite-ultimate.php') ) {
		require dirname(dirname(__DIR__)) . '/multisite-ultimate/multisite-ultimate.php';
	}
}
...
function _manually_load_addon() {
	require dirname(__DIR__) . '/ultimate-multisite-addon-template.php';
}
